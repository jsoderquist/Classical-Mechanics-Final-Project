class VideoService:
    ...
    def draw_image(self, image, position):
        ...
        Args:
            image: An instance of moon.casting.image.
            position: An instance of moon.casting.point.
    ...
    def draw_rectangle(self, size, position, color):
        ...
        Args:
            size: An instance of moon.casting.point.
            position: An instance of moon.casting.point.
            color: An instance of moon.casting.color.
        """
        raise NotImplementedError("not implemented in base class")
    ...
    def draw_text(self, text, position):
        ...
        Args:
            text: An instance of moon.casting.text.
            position: An instance of moon.casting.point.
    ...
    def initialize(self):
        """Initializes underlying video device. This method should be called before the main simulation 
        loop begins."""
        raise NotImplementedError("not implemented in base class")
    ...
    def release(self):
        """Releases the underlying video device. This method should be called after the simulation loop 
